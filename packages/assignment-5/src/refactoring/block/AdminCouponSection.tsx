...
interface AdminCouponSectionProps {
  coupons: Coupon[];
  onCouponAdd: (newCoupon: Coupon) => void;
}

const AdminCouponSection = ({ coupons, onCouponAdd }: AdminCouponSectionProps) => {
  const { newCoupon, setNewCoupon, addCoupon } = useCouponForm(onCouponAdd);
